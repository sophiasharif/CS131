...
let () = print_endline (string_of_bool computed_fixed_point_test1)
let () = print_endline (string_of_bool computed_fixed_point_test2)
let () = print_endline (string_of_bool computed_fixed_point_test3)
